...
export default class AgentAssistPayClient extends EventEmitter {
    ...
    async _getConfig(merchantServerUrl) { // OK
        ...
        try {
            ...
            console.log(`this._functionsURL: ${this._functionsURL}`);
    ...
    async attachPay(merchantServerUrl, callSid = null) {   // OK
        ...
        try {
            ...
            console.log(`attachPay: Got config: ${this._functionsURL}`);
    ...
    async startCapture() {  // OK - test
        ...
        try {
            console.log(`StartCapture: this._functionsURL: ${this._functionsURL} `);
